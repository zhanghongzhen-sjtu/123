...
## Inputs
- `data/debug/traveluav_BrushifyCountryRoads_debug.jsonl`: `60` rows
- `data/debug/traveluav_BrushifyUrban_debug.jsonl`: `60` rows
- `data/debug/traveluav_Carla_Town02_debug.jsonl`: `54` rows
