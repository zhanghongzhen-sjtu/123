...
- `data/debug/plots/combined_3way/overall_error_bar.png`
- `data/debug/plots/combined_3way/per_dim_mae_bar.png`
- `data/debug/plots/combined_3way/per_dim_rmse_bar.png`
