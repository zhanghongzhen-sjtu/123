...
- Other issue counts: `{'missing_image_file': 60}`

## Toy Data Check

- Toy data detected: `True`
- Toy/reality check notes: `['no image file exists locally', 'no raw source file or raw episode directory exists locally']`
