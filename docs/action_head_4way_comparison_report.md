...
- `data/debug/plots/combined_4way/overall_error_bar.png`
- `data/debug/plots/combined_4way/per_dim_mae_bar.png`
- `data/debug/plots/combined_4way/per_dim_rmse_bar.png`
